export const CELEBRATION_MESSAGES: string[] = [
  ...
  'Beau travail. Chaque jour comme celui-ci te rapproche du bon poste.',
  'Checklist bouclée. Maintenant, va te vider la tête — tu as bien avancé.',
  'Félicitations ! La régularité, c\'est ta meilleure alliée dans cette recherche.',
  'Tout coché. Sois fier de toi : tu as fait ta part aujourd\'hui.',
